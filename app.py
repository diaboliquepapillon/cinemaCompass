    ...
    with cols[idx]:
        ...
        try:
            if poster_url:
                ...
                st.markdown('<div style="height: 300px; background: #1E2330; display: flex; align-items: center; justify-content: center; font-size: 3rem; border-radius: 4px;">🎬</div>', unsafe_allow_html=True)
        except:
            st.markdown('<div style="height: 300px; background: #1E2330; display: flex; align-items: center; justify-content: center; font-size: 3rem; border-radius: 4px;">🎬</div>', unsafe_allow_html=True)
